...
- **Entitlements File**: `Config/PrestoTestApp.entitlements` contains all app capabilities
...
To add capabilities to your app, edit `Config/PrestoTestApp.entitlements`:
